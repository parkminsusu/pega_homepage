...
<div class="body">
	...
	<!-- 글 수정과 글작성시 처리하는 url이 다름 -->
	<c:choose>
   	<c:when test="${noticeBoard ne null}">
   		<form name="tx_editor_form" id="tx_editor_form" action="${pageContext.request.contextPath}/NoticeBoardController/updateNoticeBoardToList.do" method="post" accept-charset="utf-8">	
	</c:when>
		
	<c:otherwise>
		<form name="tx_editor_form" id="tx_editor_form" action="${pageContext.request.contextPath}/NoticeBoardController/write.do" method="post" accept-charset="utf-8">
	</c:otherwise>
	
	</c:choose>
		<!-- 에디터 컨테이너 시작 -->
		<div id="tx_trex_container" class="tx-editor-container">
			<input type="text" name="title" class="form-control" placeholder="제목" value="${noticeBoard.boardTitle}">	
			<input type="hidden" name="boardNumber" value="${noticeBoard.boardNumber}" />
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading"><div><img src="../resources/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
	...
	<div id="tx_resizer" class="tx-resize-bar">
		...
		<img id="tx_resize_holder" src="../resources/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
	</div>
					<div class="tx-side-bi" id="tx_side_bi">
		<div style="text-align: right;">
			<img hspace="4" height="14" width="78" align="absmiddle" src="../resources/daumeditor/images/icon/editor/editor_bi.png" />
		</div>
	</div>
				<!-- 편집영역 끝 -->
			<!-- 첨부박스 시작 -->
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="../resources/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
...
<button class="btn btn-base" onclick='saveContent()'>완료</button>
</div>
<!-- End: Saving Contents -->
